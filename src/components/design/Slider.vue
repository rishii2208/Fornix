...
<script setup lang="ts">
  ...
  const people = [
    {
      quote:
        'Collaborating with Fornix on multiple projects has been a true pleasure. Their exceptional attention to detail, and commitment to quality consistently made them invaluable asset to the the product.',
      author: 'Naman Jain',
      position: 'Co Founder of Darwix',
      tags: ['Fullstack Development', 'Animation', 'AI-ML'],
      profile: mohammad,
    },
    {
      quote:
        'Working with Fornix on the Zego website has been an exceptional experience. Their approach to create with industry leading stack were crucial in bringing this project to life. Thank you, Fornix!',
      author: 'Robert Aldridge',
      position: 'Founder of Zego',
