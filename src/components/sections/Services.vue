  ...
  <section id="services" class="padding-x mb-20">
    <div class="flex w-full flex-col">
      ...
      >
        ...
        >
          We know that building your dream idea is a hard
          journey. We are here to make your journey easier.
...
<script setup lang="ts">
  ...
  const servicesCardProps = [
    {
      title: 'Development',
      body: 'We create custom-coded websites & Apps specifically for your brand. We focus on making sure they are scalable, fast, accessible, and have engaging animations to provide a memorable experience for users.',
      headings: ['Modern Websites', 'Modern Apps' , 'UI & Animations'],
  ...
  `,
    },
    {
      ...
      body: 'We specialize in developing advanced applications that redefine the possibilities of online platforms, crafting progressive solutions and integrating complex systems.',
      headings: [
  ...
  `,
    },
    {
      ...
      body: 'We build leading Agentic Process Automation.Our team consists of AI developers who give free consultation to grow your business.',
      headings: [
        'AI Automation',
        'AI Agents',
        'Custom LLMs',
  ...
  onBeforeMount(() => {
    whatIDo.value = textSplitterIntoChar('What We do ', true);
  });
