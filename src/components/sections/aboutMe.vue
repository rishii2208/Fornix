  ...
  >
    ...
    <div class="padding-y md:column-gap mt-6 grid grid-cols-12">
      ...
      <div class="col-span-11 mt-10 md:col-span-8 md:col-start-6">
        ...
        >
          We help to turn your “hard-to-scope” ideas into shipped, business-critical softwares,—without the stress so you can focus on other aspects of your business.We are a team of experienced professional developers from MAANG and other top MNCs.We are 10x better at communication and understanding your needs. 
        </p>
        ...
        >
          ...
          <p class="heading-6 font-fancy w-full text-balance sm:max-w-[40ch]">
            We believe that development is so much more than just development,We are not “code producers” but “problem absorbers”. Our job is to understand what you're actually trying to accomplish?,understanding pain before prescribing solutions.The code is just the vehicle for delivering something much more valuable: your peace of mind, time, and professional reputation, so you can focus on what you do best.Our team is a group of experinced developers from Top MNCs who are dedicated to delivering high-quality code and solutions tailored to your needs.We are 10x better at communication and understanding your needs.
...
<script setup lang="ts">
  ...
  onBeforeMount(() => {
    aboutMe.value = textSplitterIntoChar(
      'Programmers, Developers, Animators',
      true,
      true,
    );
  });
