      ...
      <div class="relative flex w-full flex-col items-center">
        ...
        <div class="lg:column-gap spacing-t grid w-full grid-cols-12">
          ...
          >
            ...
            <p class="sr-only">
              We know that building your dream project is a hard journey.
          ...
          >
            ...
            <img
              ...
              :src="profile"
              alt="Fornix Technologies"
              class="size-full scale-90 rounded-lg object-cover object-top brightness-110 "
            />
          </div>
...
<script setup lang="ts">
  ...
  const whoAmI = ref(
    'Turn your ideas to reality, with cutting-edge technologies to deliver comprehensive solutions for your business.',
  );
